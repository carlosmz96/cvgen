...
import dev.carlosmz.cvgen.api.cvgenapi.auth.services.impl.MyUserDetailsService;
...
public class SecurityConfig {
    ...
    @Bean
    AuthenticationProvider authenticationProvider(MyUserDetailsService uds, PasswordEncoder passwordEncoder) {
